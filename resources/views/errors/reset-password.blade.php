                ...
                <form method="POST" action="{{ route('soda.reset-weak-password') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>@lang('soda::forms.password')</label>
                            <input type="password" name="password" class="form-control" placeholder="@lang('soda::forms.new_password')">
                        </div>
                    ...
                    <div class="modal-footer">
                        <a href="{{ route('soda.logout') }}" class="btn btn-default">@lang('soda::misc.logout')</a>
                        <button class="btn btn-primary">@lang('soda::misc.continue')</button>
                    </div>
                </form>
            </div>
        </div>
