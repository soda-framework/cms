...
class Tinymce extends AbstractFormField
{
    ...
    public function getDefaultParameters()
    {
        return [
            ...
            'toolbar1'                  => 'undo redo | forecolor backcolor styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image',
            'image_advtab'              => true,
            ...
            'images_upload_url'           => route('soda.tiny-upload'),
            ...
            'images_upload_handler' => 'function(blobInfo, success, failure, progress) {
                ...
                xhr.open(\'POST\', \''.route('soda.tiny-upload').'\');
